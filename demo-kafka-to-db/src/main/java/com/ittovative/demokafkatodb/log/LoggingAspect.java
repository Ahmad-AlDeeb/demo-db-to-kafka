package com.ittovative.demokafkatodb.log;
...
import static com.ittovative.demokafkatodb.constant.AspectConstant.AFTER_RETURN_MESSAGE;
import static com.ittovative.demokafkatodb.constant.AspectConstant.AFTER_THROW_MESSAGE;
import static com.ittovative.demokafkatodb.constant.AspectConstant.BEFORE_MESSAGE;
import static com.ittovative.demokafkatodb.util.AspectUtil.getClassName;
import static com.ittovative.demokafkatodb.util.AspectUtil.getMethodArgs;
import static com.ittovative.demokafkatodb.util.AspectUtil.getMethodName;
...
public class LoggingAspect {
     ...
     */
    @Around("execution(* com.ittovative.demokafkatodb.*.*.*(..))")
